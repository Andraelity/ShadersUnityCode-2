	...
	SubShader
	{
		...
		Pass
		{
            ...
            fixed4 frag (pixel i) : SV_Target
			{
                ...
                float4 mouseNDC = float4(mouseCoordinateScale, coordinateScale2);
                float2 diff = mouseNDC.zw - mouseNDC.xy; 

                float dist = length(diff);
                float angle = PI * dist* WAVE_SIZE + TIME * SPEED;
                ...
                col = tex2D(_TextureChannel0, newUV.xy);
